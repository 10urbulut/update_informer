...
import 'package:update_informer/update_informer_manager.dart';

typedef JsonType = Map<String, dynamic>;

class UpdateInformer extends StatelessWidget {
  const UpdateInformer({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Consumer<UpdateInformerManager>(
      builder: (__, updateInformerManager, _) => Visibility(
        visible: true,
        child: InkWell(
          onTap: () => updateInformerManager.upToDateOnTap(
